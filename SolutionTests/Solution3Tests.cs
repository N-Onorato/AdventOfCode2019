...
namespace AdventOfCode.tests {
    ...
    public class partOneTests {
        ...
        public void canCountSteps(string firstWire, string secondwire, int expectedSteps) {
            Grid countGrid = new Grid();
            countGrid.addWire(firstWire);
            countGrid.addWire(secondwire);
            int minSteps = countGrid.getMinSteps();
            Assert.AreEqual(expectedSteps, minSteps);
        }
